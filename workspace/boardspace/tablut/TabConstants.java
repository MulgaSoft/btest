...
public interface TabConstants extends Play2Constants
{
	...
	{ 	"Tablut",
        ...
        "Click on Done to confirm swapping",
	...
	static String TablutStringPairs[][] =
	{
        ...
        {"Tablut-7_variation","Tablut on a 7x7 board"},
        {"Tablut-9_variation","Tablut on a 9x9 board"},
        {"Tablut-11_variation","Tablut on a 11x11 board"},	
	};
	...
	{	String sl = s.toLowerCase();
		for(TabId v : values()) { if(sl.equals(v.shortName.toLowerCase())) { return(v); }}
		return(null);
	}
